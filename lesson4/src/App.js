...
function App() {
  ...
  const handleShowModal = () => {
    ...
    setEditTask(null); // Сбрасываем editTask при открытии модального окна
    setInput(''); // Очищаем поле ввода при открытии модального окна
  };
  ...
  const handleEditTask = (id, newTitle) => {
    ...
    setEditTask(null);
    setShowModal(false); // Закрываем модальное окно после сохранения изменений
  };

  const handleCancelEdit = () => {
    setEditTask(null);
    setShowModal(false); // Закрываем модальное окно при отмене редактирования
  };
  ...
  const handleEdit = (task) => {
    setEditTask(task);
    setInput(task.title); // Устанавливаем текущий заголовок в поле ввода
